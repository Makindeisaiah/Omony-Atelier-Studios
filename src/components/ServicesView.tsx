...
import { ArrowUpRight, Search, Sparkles, Check } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-6">
          ...
          <div className="relative min-w-[260px]">
            ...
            <input
              ...
              className="w-full bg-[#181716] border border-[#2D2B28] pl-10 pr-4 py-2 text-xs text-[#FAF8F5] placeholder-[#7A746B] focus:outline-none focus:border-[#C5A880] transition-colors rounded-none"
            />
          </div>
        </div>
      </section>
